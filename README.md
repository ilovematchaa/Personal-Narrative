...
[![Thumbnail for my projet](Thumbnail.png)][https://youtube.com/shorts/BdC0HgPCMuc]
...
The story shows my culture and what itt represents. But it also shows my interest and what I like to do.
...
I used the sharpen filter. The sharpen filter goes through each pixel checking to see if the pixel matches the other edges to make it more sharpened and evened out. I also used a green tint filter. The tint becomes more green based on the inputted intensity of the color. It does this by adding more to the green value of each pixel